...
>
  Use Camera
        ...
        <div className="home__row">
          ...
          <Product
            id="49538094"
            title="Kenwood kMix Stand Mixer for Baking, Stylish Kitchen Mixer with K-beater, Dough Hook and Whisk, 5L"
            price={239.0}
            rating={4}
          ...
          <Product
            id="29919911"
            title="Dell G16 - Gaming-focused features and robust build quality, making them a popular choice among gamers."
            price={850}
            rating={4}
          ...
          <Product
            id="82982981"
            title="IPhone 15 : Premium smartphone that boasts a combination of elegant aesthetics and powerful performance"
            price={500}
            rating={5}
